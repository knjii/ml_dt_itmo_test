# Предсказание покупки автомобильной страховки 
Проект по дисциплине "Машинное обучение"

**Задача:** Разработать модель бинарной классификации для прогнозирования приобретения автомобильной страховки (бинарная классификация)   
